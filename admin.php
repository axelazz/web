...
<body>
      ...
      <div class="header__container">
        <div class="header__inner">
          <div class="header__logo">
            <img class="logo" src="img/logo-escape.svg" alt="" />
          </div>
              ...
              <div class="main__form-inner-2">
                ...
                <form method="post" action="" class="main__info-form" id="form">
                  <div class="main__button">
                    <button class="main__publish" type="button" id="publishButton">
                      Publish
                    </button>
                  </div>
                    ...
                    <div class="main__box-inner">
                      <div class="main__form-inner">
                        <label class="main__form-label-1">
                          Title
                          <input type="text" class="main__form-input" id="title" name="title" maxlength="30" placeholder="New post" required />
                        </label>
                        <div class="main__title-required required">Title is required.</div>
                        <label class="main__form-label-1">
                          Short description
                          <input type="text" class="main__form-input" name="subtitle" id="subtitle" maxlength="70" placeholder="Please, enter any description"
                            required />
                        </label>
                        <div class="main__subtitle-required required">Short description is required.</div>
                        <label class="main__form-label-1">
                          Author name
                          <input type="text" class="main__form-input" name="author" id="author" maxlength="30" 
                            required />
                        </label>
                          ...
                          <div class="main__upload-avatar">
                            ...
                            <label class="main__form-label-1 avatar__field">
                              <div class="main__form-img">
                                <img src="img/camera.svg" alt="Preview" class="image__cameraPrev" id="nonePreview" />
                              ...
                              <div class="main__upload upload__new" id="uploadNew">
                                Upload New
                              </div>
                              <button class="main__clear-btn" type="reset" id="clearButton">
                                Remove
                              </button>
                            </label>
                          </div>
                          ...
                          <div class="main__upload-avatar main__upload-hero">
                            <label class="main__form-label-1 hero__field">
                              ...
                              <div class="main__hero-img">
                                <img src="img/camera_upload.svg" alt="Preview" id="previewHeroNone"
                                  class="prevHeroNone" />
                            ...
                            <p class="main__img-size" id="imgSizeOne">
                              Size up to 10mb. Format: png, jpeg, gif.
                            </p>
                            <div class="main__upload upload__new" id="uploadTwoNew">
                              Upload New
                            </div>
                            <button class="main__clear-btn" type="reset" id="clearTwoButton">
                              Remove
                            </button>
                          </div>
                        </div>
                          ...
                          <div class="main__upload-avatar main__upload-hero">
                            <label class="main__form-label-1 hero__field">
                              ...
                              <div class="main__hero-two">
                                <img src="img/camera_upload.svg" alt="Preview" class="prevHeroNone"
                                  id="heroImageMinNone" />
                                <img src="" alt="Preview" id="previewHeroMin" class="image_prev" />
                              </div>
                              <input type="file" class="main__form-input" name="heroImageMin" id="heroImageMin"
                                required />
                            </label>
                            <p class="main__img-size" id="imgSizeTwo">
                              Size up to 5mb. Format: png, jpeg, gif.
                            </p>
                            <div class="main__upload upload__new" id="uploadThreeNew">
                              Upload New
                            </div>
                            <button class="main__clear-btn" type="reset" id="clearThreeButton">
                              Remove
                            </button>
                          </div>
                        </div>
                            ...
                            <div class="main__recent-inner">
                              <div class="main__recent-post">
                                <div class="main__image__box">
                                  <img src="img/background-post.jpg" id="previewHeroMinTwo" />
                                </div>
                                ...
                                <div class="main__user-box">
                                  <div class="main__author">
                                    <img src="img/background-post.jpg" id="avatarPrev" />
                                  </div>
                                  <div class="main__name" id="authorPrev">
                                    Enter author name
                                  </div>
                  ...
                  <div class="main__info-container container_content">
                    <div class="main__info-title main__content-title">
                      Content
                    </div>
                    <label class="main__form-label-1 label__two">
                      Post content (plain text)
                      <textarea class="main__form-text" name="content" id="content"
                        placeholder="Type anything you want ..." required></textarea>
                    </label>
                    <label class="main__form-radios">
                      Featured
                      <input type="radio" value="1" class="main__form-radio" name="publish" id="featured"
                        required></input>
                      Most Recent
                      <input type="radio" value="0" class="main__form-radio" name="publish" id="recent"
                        required></input>
                    </label>
                  </div>
                </form>
  ...
  <script src="functional-panel.js"></script>
</body>
